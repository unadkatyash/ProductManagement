...
{
    public class ProductDependencyService : IHostedService, IDisposable
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<ProductDependencyService> _logger;
        ...
        public ProductDependencyService(IServiceProvider serviceProvider,
            ILogger<ProductDependencyService> logger, IConfiguration configuration)
        {
        ...
        private void StartListening()
        {
            try
            {
                ...
                _command = new SqlCommand(
                    "SELECT Id, Name, CategoryId, Price, Stock, CreatedAt, UpdatedAt FROM dbo.Products",
                    _connection);
